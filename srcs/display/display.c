...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/26 12:44:29 by rlandolt          #+#    #+#             */
/*   Updated: 2024/04/26 13:35:48 by rlandolt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!mlx_vars_init(instance) || !instance->mlx_ser || !instance->mlx_win
		|| !instance->mlx_img.img)
	...
	mlx_hook(instance->mlx_win, KeyRelease, KeyReleaseMask,
		handle_key_release, instance);
	mlx_hook(instance->mlx_win, ButtonPress, ButtonPressMask,
		ignore_mouse_keys, instance);
	mlx_hook(instance->mlx_win, MotionNotify, PointerMotionMask,
		mouse_movement, instance);
	mlx_loop_hook(instance->mlx_ser, const_movement, instance);
	mlx_hook(instance->mlx_win, DestroyNotify, StructureNotifyMask,
		exit_hook, instance);
