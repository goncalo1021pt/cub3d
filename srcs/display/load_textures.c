...
bool load_textures(t_session *ist)
{
	...
	ist->textures[DOOR_TEXTURE_1].img = mlx_xpm_file_to_image(ist->mlx_ser, "./includes/assets/IMG_8.xpm",&ist->textures[DOOR_TEXTURE_1].width, &ist->textures[DOOR_TEXTURE_1].height);
